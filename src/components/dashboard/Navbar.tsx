...
export default function DashboardNavbar() {
  ...
  return (
    <div className="flex max-w-[100vw] justify-between items-center px-4 py-3 bg-white border-b border-gray-200 fixed top-0 w-full z-30 sm:flex-row flex-col-reverse">
